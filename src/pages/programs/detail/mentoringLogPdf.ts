...
// 박경수님 2026-05-29 — 새 창 인쇄 함수 (printMentoringLogViaNewWindow,
// printMultipleMentoringLogs) 는 mentoringLogPrint.ts 로 분리 (V-1 슬림화).
// re-export 로 기존 import 경로 유지.
export {
  printMentoringLogViaNewWindow,
  printMultipleMentoringLogs,
} from './mentoringLogPrint';
